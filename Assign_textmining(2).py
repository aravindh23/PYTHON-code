# -*- coding: utf-8 -*-
"""
Created on Mon Mar 15 14:22:39 2021
...
for i in range(1,150):
  ...
  link = "https://www.amazon.in/product-reviews/B0773RQ55P/ref=acr_dp_hist_5?ie=UTF8&filterByStar=five_star&reviewerType=all_reviews#reviews-filter-bar"+str(i)
...
affinity_scores = book.iloc[:1]['value'].to_dict()
...
calculate_sentiment(text = 'first book')
